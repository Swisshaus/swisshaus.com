...
export default function ActiveUnderContractLayout({
  title,
  coverImage,
  date,
  author,
  ...
  return (
    <div className="relative flex flex-col w-full">
      {/* ACTIVE UNDER CONTRACT banner that fades on scroll */}
      <div 
        className="sticky top-[70px] z-10 w-full text-center py-3 mb-8 bg-orange-600 text-white font-bold text-xl md:text-3xl"
      ...
      <div className="flex flex-col md:flex-row w-full">
        ...
        <div className="md:w-2/3">
          ...
          <div className="mb-6 text-sm md:text-lg italic text-left">
            Filed under <Link href={`/category/${encodeURIComponent(category)}`} className="hover:underline font-bold text-orange-600">{category}</Link> on <DateFormatter dateString={date} />
          </div>
          {/* <div className="mb-8">
